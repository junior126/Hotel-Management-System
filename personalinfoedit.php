...
<title>Bergewate Hotel client's Infomation</title>
...
var f=document.forms["personal"]["usename"].value;
...
<option value="Congo">Congo</option>
 ...
 <input name="password" type="pass" class="ed" id="password" />  <br />

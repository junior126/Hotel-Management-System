...
<title>Detaied Billing Report of Bergwater Hotel</title>
<style type="text/css">
@import url(css1.css);
.style2 {
	font-size: 24px;
...
<div align="center"><span class="style2">Bergwater Hotel</span><br />
  Louis Trichardt<br />
  Telephone: 015 516 5160<br />
  Fax: 015 516 8903<br />
  Mobile: 076 108 5704<br />
Email: contactus@bergwater.com</div>
<p>&nbsp;</p>
...
while($row = mysql_fetch_array($result))
  ...
  echo "Cellphone Number: ".$row['cellphone']. "<br />"; 
  echo '<br />';

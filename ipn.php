...
// or add other error handling. 
 ...
 //email
 $mail_From = "From: support@bergwater.com";
 $mail_To = $email;
  ...
  while (!feof($fp)) {
    ...
    if (strcmp ($res, "VERIFIED") == 0) {
      ...
      if (($payment_status == 'Completed') &&  
         ($receiver_email == "support@bergwater.com") &&   // receiver_email is same as your account email
...
// we will send an email to say that something went wrong
          $mail_To = "ganiuowolabi07@gmail.com";
